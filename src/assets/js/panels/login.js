...
import { popup, database, changePanel, accountSelect, addAccount, config, setStatus, getErrorMessage, normalizeError } from '../utils.js';
    ...
    async getMicrosoft() {
        ...
        microsoftBtn.addEventListener("click", () => {
            ...
            ipcRenderer.invoke('Microsoft-window', this.config.client_id).then(async account_connect => {
                ...
                popupLogin.openPopup({
                    title: 'Erreur',
                    content: getErrorMessage(err, 'La connexion Microsoft a echoue.'),
                    options: true
                });
            });
        })
    ...
    async saveData(connectionData) {
        ...
        try {
            ...
            const normalizedError = normalizeError(error, {
                ...
                message: 'Impossible de recuperer les instances apres la connexion.'
            });
            console.error('Unable to load instances after login', normalizedError);
        }
